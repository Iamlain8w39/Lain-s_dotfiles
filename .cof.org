...
#+END_SRC
* Web
W3M is a web browser I use when I don't use firefox. Thanks to tools like engine-mode (which I have made a few line replacement for) it is often more convenient to use w3m. 
** Browser Function 
...
I used engine-mode but cuz it is like 200 lines more than I need I made my own engine-mode. I think this is better  
#+BEGIN_SRC emacs-lisp
;; This is a function that puts a string into w3m as a duckduckgo search after deleting the "nil".
(defun duckduckgo ()
   (interactive)
   (w3m-browse-url (format "https://duckduckgo.com/?q=%s"
                   (delq nil
	                 (browse-url-interactive-arg  "Duckduckgo: ")
))))


;; the keybinding
(global-set-key (kbd "C-x d") 'duckduckgo)
#+END_SRC
** Elfeed
...
;;Blogs and news
   (("https://protesilaos.com/master.xml" protesilaos)
    ...
    ("https://krystalkyleandfriends.substack.com/feed" kylekulinski)
...
;; Youtube
    ...
    ("https://www.youtube.com/feeds/videos.xml?channel_id=UCldfgbzNILYZA4dmDt4Cd6A" kylekulinski)
...
#+END_SRC
*** rss notifications 
I have taken this from reddit you can see [[https://www.reddit.com/r/emacs/comments/16vn6aa/is_anyone_using_elfeed_im_trying_to_add_a_hook_to/?rdt=37298][here]].
#+BEGIN_SRC 
...
#+END_SRC
* PDF-tools
I <3 PDF-tools. I think it is maybe the best PDF reader you can use linux.
** Theme 
...
;; starting the compositor
  (async-shell-command "picom --backend xrender & dunst")
